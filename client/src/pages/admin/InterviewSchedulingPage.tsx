  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const scheduleData = {
        ...
        meetingLink: undefined, // Will be auto-generated by Google Calendar
        status: 'scheduled',
      };

      const result = await scheduleApi.createInterviewSchedule(scheduleData);
      ...
      if (formData.interviewMode === 'virtual' && result.schedule) {
        ...
        if (selectedCandidate && selectedInterviewer) {
          try {
            await fetch('/api/interviews/scheduling/' + result.schedule.id + '/send-invite', {
              method: 'POST',
              headers: {
