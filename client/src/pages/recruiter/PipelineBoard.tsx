...
export const PipelineBoard: React.FC = () => {
  ...
  return (
    <div className="p-8 h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      <div className="mb-6">
      ...
      <div className="flex-1 flex overflow-x-auto gap-6 pb-4">
        {board.map((stage) => (
          <div key={stage.id} className="w-80 flex-shrink-0 flex flex-col bg-gray-100 dark:bg-gray-800 rounded-lg max-h-full">
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-white dark:bg-gray-800 rounded-t-lg">
              <h3 className="font-semibold text-gray-700 dark:text-gray-200">{stage.name}</h3>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {stage.entries.map((entry: any) => (
                <div key={entry.id} className="bg-white dark:bg-gray-700 p-4 rounded-md shadow-sm border border-gray-200 dark:border-gray-600">
