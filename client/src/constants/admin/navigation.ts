import { Bell, ClipboardCheck, FileText, LayoutDashboard, Settings, ShieldCheck, SlidersHorizontal, Users, UsersRound, Building2, Briefcase, Plus, GitPullRequest, User, Star, Calendar, BarChart2, Bell as BellIcon } from "lucide-react";
